...
A simple quality-of-life mod for **The Long Dark** (compatible with MelonLoader 0.7.2+) that prevents accidental clicks on the **WINTERMUTE** (Story Mode) button in the main menu. 
...
## Installation
1. Make sure you have [MelonLoader](https://github.com) installed for your game.
